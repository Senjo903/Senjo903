...
<table>
  <tr>
    <td width="33%">
      <strong>Realtime systems</strong><br />
  ...
  <table>
    <tr>
      <td align="center" width="96">
        <img src="./icons/Typescript.svg.png" width="42" height="42" alt="TypeScript" /><br />
        <sub>TypeScript</sub>
      </td>
      <td align="center" width="96">
        <img src="./icons/JavaScript_logo_2.svg.png" width="42" height="42" alt="JavaScript" /><br />
        <sub>JavaScript</sub>
      </td>
      <td align="center" width="96">
        <img src="./icons/nodejs-icon.svg" width="42" height="42" alt="Node.js" /><br />
        <sub>Node.js</sub>
      </td>
      <td align="center" width="96">
        <img src="./icons/reactjs-icon.svg" width="42" height="42" alt="React" /><br />
        <sub>React</sub>
      </td>
      <td align="center" width="96">
        <img src="./icons/redux.svg" width="42" height="42" alt="Redux" /><br />
        <sub>Redux</sub>
      </td>
      <td align="center" width="96">
        <img src="./icons/expressjs-icon.svg" width="42" height="42" alt="Express" /><br />
        <sub>Express</sub>
      </td>
    </tr>
    <tr>
      <td align="center" width="96">
        <img src="./icons/postgresql-icon.svg" width="42" height="42" alt="PostgreSQL" /><br />
        <sub>PostgreSQL</sub>
      </td>
      <td align="center" width="96">
        <img src="./icons/sequelizejs-icon.svg" width="42" height="42" alt="Sequelize" /><br />
        <sub>Sequelize</sub>
      </td>
      <td align="center" width="96">
        <img src="./icons/python.svg.png" width="42" height="42" alt="Python" /><br />
        <sub>Python</sub>
      </td>
      <td align="center" width="96">
        <img src="./icons/git-scm-icon.svg" width="42" height="42" alt="Git" /><br />
        <sub>Git</sub>
      </td>
      <td align="center" width="96">
        <img src="./icons/w3_html5-icon.svg" width="42" height="42" alt="HTML5" /><br />
        <sub>HTML5</sub>
      </td>
      <td align="center" width="96">
        <img src="./icons/css3.svg" width="42" height="42" alt="CSS3" /><br />
        <sub>CSS3</sub>
      </td>
    </tr>
  </table>
